...
ln -s /Users/lev/Documents/Projects/DicksonRingPotential/simulate2.py

python simulate2.py -b {beta} -i {sid} --nblocks {nblocks} --steps {steps} --dsize {dsize} >/dev/null &
wait
"""
