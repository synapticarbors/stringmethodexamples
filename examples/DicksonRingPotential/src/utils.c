/* Generated by Cython 0.16 on Thu Nov  1 10:55:26 2012 */
...
static PyObject *__pyx_pf_5utils_2calc_wemd_rate(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_pcoords, PyArrayObject *__pyx_v_weight) {
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_weight.rcbuffer->pybuffer, (PyObject*)__pyx_v_weight, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float64_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 43; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
