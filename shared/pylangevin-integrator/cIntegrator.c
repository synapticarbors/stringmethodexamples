/* Generated by Cython 0.16 on Thu Oct  4 13:37:17 2012 */
...
#endif
#include <math.h>
#define __PYX_HAVE__cIntegrator
#define __PYX_HAVE_API__cIntegrator
#include "stdio.h"
#include "stdlib.h"
 ...
 * include "Python.pxi"
 */
typedef __pyx_t_5numpy_float32_t __pyx_t_11cIntegrator_DTYPE_t;
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
struct __pyx_obj_11cIntegrator_Integrator;
...
struct __pyx_obj_11cIntegrator_Integrator {
  ...
  __pyx_t_11cIntegrator_DTYPE_t *_Fn;
  rk_state *rng_state;
};
...
/* Module declarations from 'cIntegrator' */
static PyTypeObject *__pyx_ptype_11cIntegrator_Integrator = 0;
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_11cIntegrator_DTYPE_t = { "DTYPE_t", NULL, sizeof(__pyx_t_11cIntegrator_DTYPE_t), { 0 }, 0, 'R', 0, 0 };
#define __Pyx_MODULE_NAME "cIntegrator"
int __pyx_module_is_main_cIntegrator = 0;

/* Implementation of 'cIntegrator' */
static PyObject *__pyx_builtin_xrange;
static PyObject *__pyx_builtin_ValueError;
static PyObject *__pyx_builtin_range;
static PyObject *__pyx_builtin_RuntimeError;
static int __pyx_pf_11cIntegrator_10Integrator___cinit__(struct __pyx_obj_11cIntegrator_Integrator *__pyx_v_self, CYTHON_UNUSED struct __pyx_obj_11ForceFields_Force *__pyx_v_forcefield, CYTHON_UNUSED double __pyx_v_mass, CYTHON_UNUSED double __pyx_v_nu, CYTHON_UNUSED double __pyx_v_beta, CYTHON_UNUSED double __pyx_v_dt, unsigned int __pyx_v_dims, CYTHON_UNUSED unsigned long __pyx_v_seed); /* proto */
static void __pyx_pf_11cIntegrator_10Integrator_2__dealloc__(struct __pyx_obj_11cIntegrator_Integrator *__pyx_v_self); /* proto */
static int __pyx_pf_11cIntegrator_10Integrator_4__init__(struct __pyx_obj_11cIntegrator_Integrator *__pyx_v_self, struct __pyx_obj_11ForceFields_Force *__pyx_v_forcefield, double __pyx_v_mass, double __pyx_v_nu, double __pyx_v_beta, double __pyx_v_dt, unsigned int __pyx_v_dims, unsigned long __pyx_v_seed); /* proto */
static PyObject *__pyx_pf_11cIntegrator_10Integrator_6step(struct __pyx_obj_11cIntegrator_Integrator *__pyx_v_self, PyArrayObject *__pyx_v_coords, PyArrayObject *__pyx_v_velocs, int __pyx_v_steps); /* proto */
...
static char __pyx_k__velocs[] = "velocs";
...
static PyObject *__pyx_n_s__velocs;
...
/* Python wrapper */
static int __pyx_pw_11cIntegrator_10Integrator_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static int __pyx_pw_11cIntegrator_10Integrator_1__cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  CYTHON_UNUSED struct __pyx_obj_11ForceFields_Force *__pyx_v_forcefield = 0;
  CYTHON_UNUSED double __pyx_v_mass;
  CYTHON_UNUSED double __pyx_v_nu;
  ...
  static PyObject **__pyx_pyargnames[] = {&__pyx_n_s__forcefield,&__pyx_n_s__mass,&__pyx_n_s__nu,&__pyx_n_s__beta,&__pyx_n_s__dt,&__pyx_n_s__dims,&__pyx_n_s__seed,0};
  int __pyx_r;
  ...
  __Pyx_RefNannySetupContext("__cinit__ (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        case  2:
        values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__nu);
        ...
        case  6:
        values[6] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__seed);
    ...
    __pyx_v_mass = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_mass == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 32; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_nu = __pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_nu == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 32; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_beta = __pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_beta == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 32; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_dt = __pyx_PyFloat_AsDouble(values[4]); if (unlikely((__pyx_v_dt == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 32; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_dims = __Pyx_PyInt_AsUnsignedInt(values[5]); if (unlikely((__pyx_v_dims == (unsigned int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 32; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_seed = __Pyx_PyInt_AsUnsignedLong(values[6]); if (unlikely((__pyx_v_seed == (unsigned long)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 32; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("cIntegrator.Integrator.__cinit__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return -1;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_forcefield), __pyx_ptype_11ForceFields_Force, 1, "forcefield", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 32; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_r = __pyx_pf_11cIntegrator_10Integrator___cinit__(((struct __pyx_obj_11cIntegrator_Integrator *)__pyx_v_self), __pyx_v_forcefield, __pyx_v_mass, __pyx_v_nu, __pyx_v_beta, __pyx_v_dt, __pyx_v_dims, __pyx_v_seed);
  goto __pyx_L0;
  __pyx_L1_error:;
  __pyx_r = -1;
  __pyx_L0:;
...
static int __pyx_pf_11cIntegrator_10Integrator___cinit__(struct __pyx_obj_11cIntegrator_Integrator *__pyx_v_self, CYTHON_UNUSED struct __pyx_obj_11ForceFields_Force *__pyx_v_forcefield, CYTHON_UNUSED double __pyx_v_mass, CYTHON_UNUSED double __pyx_v_nu, CYTHON_UNUSED double __pyx_v_beta, CYTHON_UNUSED double __pyx_v_dt, unsigned int __pyx_v_dims, CYTHON_UNUSED unsigned long __pyx_v_seed) {
  int __pyx_r;
  __Pyx_RefNannyDeclarations
 ...
 * 
 */
  __pyx_v_self->_Fn = ((__pyx_t_11cIntegrator_DTYPE_t *)PyMem_Malloc((__pyx_v_dims * (sizeof(__pyx_t_11cIntegrator_DTYPE_t)))));
...
/* Python wrapper */
static void __pyx_pw_11cIntegrator_10Integrator_3__dealloc__(PyObject *__pyx_v_self); /*proto*/
static void __pyx_pw_11cIntegrator_10Integrator_3__dealloc__(PyObject *__pyx_v_self) {
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__dealloc__ (wrapper)", 0);
  __pyx_pf_11cIntegrator_10Integrator_2__dealloc__(((struct __pyx_obj_11cIntegrator_Integrator *)__pyx_v_self));
  __Pyx_RefNannyFinishContext();
}
...
static void __pyx_pf_11cIntegrator_10Integrator_2__dealloc__(struct __pyx_obj_11cIntegrator_Integrator *__pyx_v_self) {
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
 ...
 *             self._Fn = NULL
 */
  __pyx_t_1 = (__pyx_v_self->_Fn != NULL);
  if (__pyx_t_1) {
...
/* Python wrapper */
static int __pyx_pw_11cIntegrator_10Integrator_5__init__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static int __pyx_pw_11cIntegrator_10Integrator_5__init__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("__init__ (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely(values[1])) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("__init__", 1, 7, 7, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 45; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__nu);
        if (likely(values[2])) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("__init__", 1, 7, 7, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 45; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  3:
        values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__beta);
        if (likely(values[3])) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("__init__", 1, 7, 7, 3); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 45; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  4:
        values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__dt);
        if (likely(values[4])) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("__init__", 1, 7, 7, 4); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 45; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  5:
        values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__dims);
        if (likely(values[5])) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("__init__", 1, 7, 7, 5); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 45; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  6:
        values[6] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__seed);
        if (likely(values[6])) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("__init__", 1, 7, 7, 6); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 45; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
    ...
    __pyx_v_nu = __pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_nu == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 45; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_beta = __pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_beta == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 45; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_dt = __pyx_PyFloat_AsDouble(values[4]); if (unlikely((__pyx_v_dt == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 45; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_dims = __Pyx_PyInt_AsUnsignedInt(values[5]); if (unlikely((__pyx_v_dims == (unsigned int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 45; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_seed = __Pyx_PyInt_AsUnsignedLong(values[6]); if (unlikely((__pyx_v_seed == (unsigned long)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 45; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("__init__", 1, 7, 7, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 45; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("cIntegrator.Integrator.__init__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return -1;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_forcefield), __pyx_ptype_11ForceFields_Force, 1, "forcefield", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 45; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_r = __pyx_pf_11cIntegrator_10Integrator_4__init__(((struct __pyx_obj_11cIntegrator_Integrator *)__pyx_v_self), __pyx_v_forcefield, __pyx_v_mass, __pyx_v_nu, __pyx_v_beta, __pyx_v_dt, __pyx_v_dims, __pyx_v_seed);
  goto __pyx_L0;
  __pyx_L1_error:;
  __pyx_r = -1;
  __pyx_L0:;
...
static int __pyx_pf_11cIntegrator_10Integrator_4__init__(struct __pyx_obj_11cIntegrator_Integrator *__pyx_v_self, struct __pyx_obj_11ForceFields_Force *__pyx_v_forcefield, double __pyx_v_mass, double __pyx_v_nu, double __pyx_v_beta, double __pyx_v_dt, unsigned int __pyx_v_dims, unsigned long __pyx_v_seed) {
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  double __pyx_t_1;
  double __pyx_t_2;
 ...
 */
  ...
  __pyx_v_self->_invmass = (1.0 / __pyx_v_mass);
 ...
 */
  __pyx_t_1 = (2.0 * __pyx_v_self->_nu);
  __pyx_t_2 = (__pyx_v_self->_beta * __pyx_v_self->_mass);
 ...
 * 
 */
  __pyx_v_self->_b1 = ((1.0 - ((0.5 * __pyx_v_self->_dt) * __pyx_v_self->_nu)) + ((0.125 * pow(__pyx_v_self->_dt, 2.0)) * pow(__pyx_v_self->_nu, 2.0)));
 ...
 *         self._s3 = sqrt(3.0)
 */
  __pyx_v_self->_b2 = ((0.5 * __pyx_v_self->_dt) - ((0.125 * __pyx_v_self->_nu) * pow(__pyx_v_self->_dt, 2.0)));
 ...
 * 
 */
  __pyx_v_self->_sdt3 = (__pyx_v_self->_sigma * sqrt(pow(__pyx_v_self->_dt, 3.0)));
 ...
 */
  __pyx_v_self->_sdt = (__pyx_v_self->_sigma * sqrt(__pyx_v_self->_dt));
...
/* Python wrapper */
static PyObject *__pyx_pw_11cIntegrator_10Integrator_7step(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_11cIntegrator_10Integrator_7step(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_coords = 0;
  PyArrayObject *__pyx_v_velocs = 0;
  int __pyx_v_steps;
  static PyObject **__pyx_pyargnames[] = {&__pyx_n_s__coords,&__pyx_n_s__velocs,&__pyx_n_s__steps,0};
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("step (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        case  1:
        values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__velocs);
        if (likely(values[1])) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("step", 1, 3, 3, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 69; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__steps);
        if (likely(values[2])) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("step", 1, 3, 3, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 69; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
    ...
    __pyx_v_velocs = ((PyArrayObject *)values[1]);
    __pyx_v_steps = __Pyx_PyInt_AsInt(values[2]); if (unlikely((__pyx_v_steps == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 69; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("step", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 69; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("cIntegrator.Integrator.step", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_coords), __pyx_ptype_5numpy_ndarray, 1, "coords", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 69; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_velocs), __pyx_ptype_5numpy_ndarray, 1, "velocs", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 69; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_r = __pyx_pf_11cIntegrator_10Integrator_6step(((struct __pyx_obj_11cIntegrator_Integrator *)__pyx_v_self), __pyx_v_coords, __pyx_v_velocs, __pyx_v_steps);
  goto __pyx_L0;
  __pyx_L1_error:;
  __pyx_r = NULL;
  __pyx_L0:;
...
static PyObject *__pyx_pf_11cIntegrator_10Integrator_6step(struct __pyx_obj_11cIntegrator_Integrator *__pyx_v_self, PyArrayObject *__pyx_v_coords, PyArrayObject *__pyx_v_velocs, int __pyx_v_steps) {
  ...
  __Pyx_LocalBuf_ND __pyx_pybuffernd_n5;
  __Pyx_Buffer __pyx_pybuffer_n5;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_velocs;
  __Pyx_Buffer __pyx_pybuffer_velocs;
  ...
  __pyx_pybuffer_n5.pybuffer.buf = NULL;
  __pyx_pybuffer_n5.refcount = 0;
  __pyx_pybuffernd_n5.data = NULL;
  __pyx_pybuffernd_n5.rcbuffer = &__pyx_pybuffer_n5;
  ...
  __pyx_pybuffer_velocs.pybuffer.buf = NULL;
  __pyx_pybuffer_velocs.refcount = 0;
  __pyx_pybuffernd_velocs.data = NULL;
  __pyx_pybuffernd_velocs.rcbuffer = &__pyx_pybuffer_velocs;
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_coords.rcbuffer->pybuffer, (PyObject*)__pyx_v_coords, &__Pyx_TypeInfo_nn___pyx_t_11cIntegrator_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 69; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_velocs.rcbuffer->pybuffer, (PyObject*)__pyx_v_velocs, &__Pyx_TypeInfo_nn___pyx_t_11cIntegrator_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 69; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_pybuffernd_velocs.diminfo[0].strides = __pyx_pybuffernd_velocs.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_velocs.diminfo[0].shape = __pyx_pybuffernd_velocs.rcbuffer->pybuffer.shape[0];
 ...
 */
  ...
  __pyx_t_1 = PyLong_FromUnsignedLong(__pyx_v_self->_dims); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 72; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __pyx_t_4 = __Pyx_GetName(__pyx_m, __pyx_n_s__DTYPE); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 72; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  if (PyDict_SetItem(__pyx_t_3, ((PyObject *)__pyx_n_s__dtype), __pyx_t_4) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 72; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_F.rcbuffer->pybuffer, (PyObject*)__pyx_t_5, &__Pyx_TypeInfo_nn___pyx_t_11cIntegrator_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_3 = PyObject_GetAttr(__pyx_t_4, __pyx_n_s__zeros); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 73; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = PyLong_FromUnsignedLong(__pyx_v_self->_dims); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 73; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  ...
  __pyx_t_2 = __Pyx_GetName(__pyx_m, __pyx_n_s__DTYPE); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 73; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = PyObject_Call(__pyx_t_3, ((PyObject *)__pyx_t_4), ((PyObject *)__pyx_t_1)); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 73; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_n5.rcbuffer->pybuffer, (PyObject*)__pyx_t_6, &__Pyx_TypeInfo_nn___pyx_t_11cIntegrator_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {
      __pyx_v_n5 = ((PyArrayObject *)Py_None); __Pyx_INCREF(Py_None); __pyx_pybuffernd_n5.rcbuffer->pybuffer.buf = NULL;
      {__pyx_filename = __pyx_f[0]; __pyx_lineno = 73; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    } else {__pyx_pybuffernd_n5.diminfo[0].strides = __pyx_pybuffernd_n5.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_n5.diminfo[0].shape = __pyx_pybuffernd_n5.rcbuffer->pybuffer.shape[0];
    }
  }
  __pyx_t_6 = 0;
  __pyx_v_n5 = ((PyArrayObject *)__pyx_t_2);
  __pyx_t_2 = 0;
 ...
 * 
 */
      __pyx_v_xi = rk_gauss(__pyx_v_self->rng_state);
 ...
 */
      __pyx_v_n1 = ((0.5 * __pyx_v_self->_sdt) * __pyx_v_xi);
 ...
 *                n5[d] = n1 - self._nu*n4
 */
      __pyx_t_11 = ((0.5 * __pyx_v_self->_sdt3) * __pyx_v_eta);
      if (unlikely(__pyx_v_self->_s3 == 0)) {
        PyErr_Format(PyExc_ZeroDivisionError, "float division");
        {__pyx_filename = __pyx_f[0]; __pyx_lineno = 82; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      }
      __pyx_v_n3 = (__pyx_t_11 / __pyx_v_self->_s3);
 ...
 * 
 */
      __pyx_t_11 = (0.25 * __pyx_v_eta);
      if (unlikely(__pyx_v_self->_s3 == 0)) {
        PyErr_Format(PyExc_ZeroDivisionError, "float division");
        {__pyx_filename = __pyx_f[0]; __pyx_lineno = 83; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      }
      __pyx_v_n4 = (__pyx_v_self->_sdt3 * ((0.125 * __pyx_v_xi) + (__pyx_t_11 / __pyx_v_self->_s3)));
 ...
 */
      ...
      *__Pyx_BufPtrStrided1d(__pyx_t_11cIntegrator_DTYPE_t *, __pyx_pybuffernd_n5.rcbuffer->pybuffer.buf, __pyx_t_12, __pyx_pybuffernd_n5.diminfo[0].strides) = (__pyx_v_n1 - (__pyx_v_self->_nu * __pyx_v_n4));
 ...
 */
      ...
      *__Pyx_BufPtrStrided1d(__pyx_t_11cIntegrator_DTYPE_t *, __pyx_pybuffernd_velocs.rcbuffer->pybuffer.buf, __pyx_t_15, __pyx_pybuffernd_velocs.diminfo[0].strides) = ((((*__Pyx_BufPtrStrided1d(__pyx_t_11cIntegrator_DTYPE_t *, __pyx_pybuffernd_velocs.rcbuffer->pybuffer.buf, __pyx_t_13, __pyx_pybuffernd_velocs.diminfo[0].strides)) * __pyx_v_self->_b1) + ((__pyx_v_self->_Fn[__pyx_v_d]) * __pyx_v_self->_b2)) + (*__Pyx_BufPtrStrided1d(__pyx_t_11cIntegrator_DTYPE_t *, __pyx_pybuffernd_n5.rcbuffer->pybuffer.buf, __pyx_t_14, __pyx_pybuffernd_n5.diminfo[0].strides)));
 ...
 */
      ...
      *__Pyx_BufPtrStrided1d(__pyx_t_11cIntegrator_DTYPE_t *, __pyx_pybuffernd_coords.rcbuffer->pybuffer.buf, __pyx_t_18, __pyx_pybuffernd_coords.diminfo[0].strides) = (((*__Pyx_BufPtrStrided1d(__pyx_t_11cIntegrator_DTYPE_t *, __pyx_pybuffernd_coords.rcbuffer->pybuffer.buf, __pyx_t_16, __pyx_pybuffernd_coords.diminfo[0].strides)) + (__pyx_v_self->_dt * (*__Pyx_BufPtrStrided1d(__pyx_t_11cIntegrator_DTYPE_t *, __pyx_pybuffernd_velocs.rcbuffer->pybuffer.buf, __pyx_t_17, __pyx_pybuffernd_velocs.diminfo[0].strides)))) + __pyx_v_n3);
    }
 ...
 */
      ...
      *__Pyx_BufPtrStrided1d(__pyx_t_11cIntegrator_DTYPE_t *, __pyx_pybuffernd_F.rcbuffer->pybuffer.buf, __pyx_t_19, __pyx_pybuffernd_F.diminfo[0].strides) *= __pyx_v_self->_invmass;
 ...
 */
      ...
      *__Pyx_BufPtrStrided1d(__pyx_t_11cIntegrator_DTYPE_t *, __pyx_pybuffernd_velocs.rcbuffer->pybuffer.buf, __pyx_t_23, __pyx_pybuffernd_velocs.diminfo[0].strides) = ((((*__Pyx_BufPtrStrided1d(__pyx_t_11cIntegrator_DTYPE_t *, __pyx_pybuffernd_velocs.rcbuffer->pybuffer.buf, __pyx_t_20, __pyx_pybuffernd_velocs.diminfo[0].strides)) * __pyx_v_self->_b1) + ((*__Pyx_BufPtrStrided1d(__pyx_t_11cIntegrator_DTYPE_t *, __pyx_pybuffernd_F.rcbuffer->pybuffer.buf, __pyx_t_21, __pyx_pybuffernd_F.diminfo[0].strides)) * __pyx_v_self->_b2)) + (*__Pyx_BufPtrStrided1d(__pyx_t_11cIntegrator_DTYPE_t *, __pyx_pybuffernd_n5.rcbuffer->pybuffer.buf, __pyx_t_22, __pyx_pybuffernd_n5.diminfo[0].strides)));
 ...
 */
      ...
      (__pyx_v_self->_Fn[__pyx_v_d]) = (*__Pyx_BufPtrStrided1d(__pyx_t_11cIntegrator_DTYPE_t *, __pyx_pybuffernd_F.rcbuffer->pybuffer.buf, __pyx_t_24, __pyx_pybuffernd_F.diminfo[0].strides));
    }
  }
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_n5.rcbuffer->pybuffer);
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_velocs.rcbuffer->pybuffer);
...
static PyObject *__pyx_tp_new_11cIntegrator_Integrator(PyTypeObject *t, PyObject *a, PyObject *k) {
  struct __pyx_obj_11cIntegrator_Integrator *p;
  PyObject *o = (*t->tp_alloc)(t, 0);
  if (!o) return 0;
  p = ((struct __pyx_obj_11cIntegrator_Integrator *)o);
  p->_ff = ((struct __pyx_obj_11ForceFields_Force *)Py_None); Py_INCREF(Py_None);
  if (__pyx_pw_11cIntegrator_10Integrator_1__cinit__(o, a, k) < 0) {
    Py_DECREF(o); o = 0;
  }
  return o;
}

static void __pyx_tp_dealloc_11cIntegrator_Integrator(PyObject *o) {
  struct __pyx_obj_11cIntegrator_Integrator *p = (struct __pyx_obj_11cIntegrator_Integrator *)o;
  {
    PyObject *etype, *eval, *etb;
    PyErr_Fetch(&etype, &eval, &etb);
    ++Py_REFCNT(o);
    __pyx_pw_11cIntegrator_10Integrator_3__dealloc__(o);
...
static int __pyx_tp_traverse_11cIntegrator_Integrator(PyObject *o, visitproc v, void *a) {
  int e;
  struct __pyx_obj_11cIntegrator_Integrator *p = (struct __pyx_obj_11cIntegrator_Integrator *)o;
  if (p->_ff) {
...
static int __pyx_tp_clear_11cIntegrator_Integrator(PyObject *o) {
  struct __pyx_obj_11cIntegrator_Integrator *p = (struct __pyx_obj_11cIntegrator_Integrator *)o;
  PyObject* tmp;
  tmp = ((PyObject*)p->_ff);
  p->_ff = ((struct __pyx_obj_11ForceFields_Force *)Py_None); Py_INCREF(Py_None);
...
static PyMethodDef __pyx_methods_11cIntegrator_Integrator[] = {
  {__Pyx_NAMESTR("step"), (PyCFunction)__pyx_pw_11cIntegrator_10Integrator_7step, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(0)},
  {0, 0, 0, 0}
};

static PyNumberMethods __pyx_tp_as_number_Integrator = {
  0, /*nb_add*/
  0, /*nb_subtract*/
  0, /*nb_multiply*/
  #if PY_MAJOR_VERSION < 3
...
static PySequenceMethods __pyx_tp_as_sequence_Integrator = {
  0, /*sq_length*/
  0, /*sq_concat*/
  0, /*sq_repeat*/
  0, /*sq_item*/
...
static PyMappingMethods __pyx_tp_as_mapping_Integrator = {
  0, /*mp_length*/
  0, /*mp_subscript*/
  0, /*mp_ass_subscript*/
};

static PyBufferProcs __pyx_tp_as_buffer_Integrator = {
  #if PY_MAJOR_VERSION < 3
  0, /*bf_getreadbuffer*/
  #endif
  #if PY_MAJOR_VERSION < 3
...
static PyTypeObject __pyx_type_11cIntegrator_Integrator = {
  PyVarObject_HEAD_INIT(0, 0)
  __Pyx_NAMESTR("cIntegrator.Integrator"), /*tp_name*/
  sizeof(struct __pyx_obj_11cIntegrator_Integrator), /*tp_basicsize*/
  0, /*tp_itemsize*/
  __pyx_tp_dealloc_11cIntegrator_Integrator, /*tp_dealloc*/
  0, /*tp_print*/
  0, /*tp_getattr*/
  0, /*tp_setattr*/
  #if PY_MAJOR_VERSION < 3
  ...
  #endif
  0, /*tp_repr*/
  &__pyx_tp_as_number_Integrator, /*tp_as_number*/
  &__pyx_tp_as_sequence_Integrator, /*tp_as_sequence*/
  &__pyx_tp_as_mapping_Integrator, /*tp_as_mapping*/
  0, /*tp_hash*/
  0, /*tp_call*/
  0, /*tp_str*/
  0, /*tp_getattro*/
  0, /*tp_setattro*/
  &__pyx_tp_as_buffer_Integrator, /*tp_as_buffer*/
  Py_TPFLAGS_DEFAULT|Py_TPFLAGS_CHECKTYPES|Py_TPFLAGS_HAVE_NEWBUFFER|Py_TPFLAGS_BASETYPE|Py_TPFLAGS_HAVE_GC, /*tp_flags*/
  0, /*tp_doc*/
  __pyx_tp_traverse_11cIntegrator_Integrator, /*tp_traverse*/
  __pyx_tp_clear_11cIntegrator_Integrator, /*tp_clear*/
  0, /*tp_richcompare*/
  0, /*tp_weaklistoffset*/
  0, /*tp_iter*/
  0, /*tp_iternext*/
  __pyx_methods_11cIntegrator_Integrator, /*tp_methods*/
  0, /*tp_members*/
  0, /*tp_getset*/
  0, /*tp_base*/
  0, /*tp_dict*/
  ...
  0, /*tp_descr_set*/
  0, /*tp_dictoffset*/
  __pyx_pw_11cIntegrator_10Integrator_5__init__, /*tp_init*/
  0, /*tp_alloc*/
  __pyx_tp_new_11cIntegrator_Integrator, /*tp_new*/
  0, /*tp_free*/
  0, /*tp_is_gc*/
  0, /*tp_bases*/
  0, /*tp_mro*/
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s__velocs, __pyx_k__velocs, sizeof(__pyx_k__velocs), 0, 0, 1, 1},
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initcIntegrator(void); /*proto*/
PyMODINIT_FUNC initcIntegrator(void)
#else
PyMODINIT_FUNC PyInit_cIntegrator(void); /*proto*/
PyMODINIT_FUNC PyInit_cIntegrator(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_cIntegrator(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("cIntegrator"), __pyx_methods, 0, 0, PYTHON_API_VERSION);
  #else
  ...
  if (__pyx_module_is_main_cIntegrator) {
  ...
  /*--- Type init code ---*/
  if (PyType_Ready(&__pyx_type_11cIntegrator_Integrator) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 24; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_SetAttrString(__pyx_m, "Integrator", (PyObject *)&__pyx_type_11cIntegrator_Integrator) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 24; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_ptype_11cIntegrator_Integrator = &__pyx_type_11cIntegrator_Integrator;
  /*--- Type import code ---*/
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_2);
  if (__pyx_m) {
    __Pyx_AddTraceback("init cIntegrator", __pyx_clineno, __pyx_lineno, __pyx_filename);
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init cIntegrator");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
